...
posts
    ...
    .then((data) => {
        ...
        latest_posts.splice(0, latest_posts.length, ...data.filter((e) => e.type === "review"));
        latest_annoucement.splice(0, latest_posts.length, ...data.filter((e) => e.type === "others"));
    })
    .catch(console.error)
    .finally(() => {
